...
from RankBasedStochasticPooling import RankBasedStochasticPoolingLayer
...
def replace_max_by_RSP(model):
    ...
    for layer in other_layers:
        if isinstance(layer, tf.keras.layers.MaxPooling2D):
            layer = RankBasedStochasticPoolingLayer(alpha=0.5, pool_size=3)
        x = layer(x)
...
save_dir = "C:\\Users\\eikei\\OneDrive\\Desktop\\Uni\\Masterarbeit\\MasterThesisProject\\Models\\VGG19\\"
...
checkpoint = tf.keras.callbacks.ModelCheckpoint(save_dir+"RSP.keras", 
